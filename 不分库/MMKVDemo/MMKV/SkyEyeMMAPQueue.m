...
static NSString * QueueMax = @"queueMax";
@interface PREFIXNAME(MMAPQueue)()
{
    int _queueHead;
    int _queueTail;
    int _queueMax;
...
@end
@implementation PREFIXNAME(MMAPQueue)
...
-(instancetype) initWithCoder:(NSCoder *)coder {
    ...
    if(self) {
        ...
        _queueMax = [coder decodeIntForKey:QueueMax];
    }
    return self;
}
...
-(void) encodeWithCoder:(NSCoder *)coder {
    ...
    [coder encodeInt:_queueMax forKey:QueueMax];
}
